...
(function (root) {
  ...
  /**
   * fdescribeComponent wraps jasmine.Env.prototype.fdescribeComponent, providing a global
   * variable to access the current jasmine environment
   *
   * @param componentPath
   * @param specDefinitions
   */
  root.fdescribeComponent = function (componentPath, specDefinitions) {
    jasmine.getEnv().fdescribeComponent(componentPath, specDefinitions);
  };
  jasmine.Env.prototype.fdescribeComponent = function (componentPath, specDefinitions) {
    fdescribe(componentPath, describeComponentFactory(componentPath, specDefinitions));
  };
  ...
  /**
   * fdescribeMixin wraps jasmine.Env.prototype.fdescribeMixin, providing a global
   * variable to access the current jasmine environment
   *
   * @param componentPath
   * @param specDefinitions
   */
  root.fdescribeMixin = function (mixinPath, specDefinitions) {
    jasmine.getEnv().fdescribeMixin(mixinPath, specDefinitions);
  };
  jasmine.Env.prototype.fdescribeMixin = function (mixinPath, specDefinitions) {
    fdescribe(mixinPath, describeMixinFactory(mixinPath, specDefinitions));
  };
